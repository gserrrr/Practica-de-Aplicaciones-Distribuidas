...
import perabd.DBActionsGlobal;
import perabd.DBActionsNameBasics;
import perabd.DBActionsPeliculas;
import perabd.DBActionsPersonaPeli;
import perabd.DBActionsPoblaciones;
import perabd.DBActionsRatingPelis;
import perabd.DBActionsUsers;
...
public class bdpeliculas extends HttpServlet {
    ...
    private String gestionPeticion(HttpServletRequest request) {
        ...
        }else if (operacion.contentEquals("cantporrating")){
            DBActionsRatingPelis dbarp = new DBActionsRatingPelis();
            res = dbarp.getCantidPorRating(par);
        }else if(operacion.contentEquals("infopersona")){
            DBActionsGlobal dbarp = new DBActionsGlobal();
            res = dbarp.getInfoTabla(par);
